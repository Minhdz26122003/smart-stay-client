...
class _Initial implements PropertyState {
  const _Initial();
...
class _Loading implements PropertyState {
  const _Loading();
...
class _Loaded implements PropertyState {
  const _Loaded(final  List<Property> properties, this.selectedProperty): _properties = properties;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._properties, _properties)&&(identical(other.selectedProperty, selectedProperty) || other.selectedProperty == selectedProperty));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_properties),selectedProperty);

@override
String toString() {
  return 'PropertyState.loaded(properties: $properties, selectedProperty: $selectedProperty)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $PropertyStateCopyWith<$Res> {
...
/// Create a copy of PropertyState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? properties = null,Object? selectedProperty = freezed,}) {
  return _then(_Loaded(
null == properties ? _self._properties : properties // ignore: cast_nullable_to_non_nullable
as List<Property>,freezed == selectedProperty ? _self.selectedProperty : selectedProperty // ignore: cast_nullable_to_non_nullable
as Property?,
  ));
}
...
class _Error implements PropertyState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $PropertyStateCopyWith<$Res> {
